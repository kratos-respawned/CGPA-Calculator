...
let Home = () => {
  ...
  return (
    <div className="w-screen h-screen grid place-items-center bg-hero-pattern bg-cover font-OpenSans">
      <div
        className="flex flex-col items-center justify-start p-5 w-[300px] h-auto"
        style={glass}
      >
        <i className="fas fa-calculator text-[#2bae8f] text-[60px] my-2"></i>
        <h1 className="text-white font-semibold my-3 text-2xl opacity-50">
          CGPA CALCULATOR
        </h1>
        <form className="flex flex-col items-center justify-start w-full">
          {display === 1 ? (
            <>
              <label
                className="text-white font-semibold my-3 text-2xl opacity-80 tracking-wider"
                htmlFor="marks"
              >
                {subjects[iterator].subject}
              </label>
              <input
              ...
              />
              <button
                className="px-3 py-2 mt-5 bg-[#2bae8fc1] uppercase tracking-wider text-[#cbfff38c] font-medium hover:bg-[#2bae8f] hover:text-[#fff] hover:font-semibold rounded-sm transition shadow"
            ...
            <>
              <h2 className="text-white font-semibold my-3 text-base opacity-90">
                CGPA :: {marks / 24.0}
              </h2>
              <button
                className="px-3 py-2 mt-5 bg-[#2bae8fc1] uppercase tracking-wider text-[#cbfff38c] font-medium hover:bg-[#2bae8f] hover:text-[#fff] hover:font-semibold rounded-sm transition shadow"
